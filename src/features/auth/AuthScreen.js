    ...
    render() {
        return `
            <div class="auth-box">
                ...
                <button class="btn-google" id="authGoogleSignIn">
                ...
                <p class="auth-error" id="authErrorInner"></p>
            </div>
        `;
    }
